...
namespace CS2WPF.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CrtWpfScriptsCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrtWpfScriptsCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private CrtWpfScriptsCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CrtWpfScriptsCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in CrtWpfScriptsCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new CrtWpfScriptsCommand(package, commandService);
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            MainWindowWpfScripts dataContext = new MainWindowWpfScripts(new PrismModuleModifier(dTE2), dTE2, TextTemplating, DialogFactory);
